...
export default function Mobile({ userName, filtered, filter, setFilter, search, setSearch, loading, activeCount, deviceId, isAdmin, onScan, onAddMechanic, onMarkWrittenOff, onDelete, onLogout, onRefresh, onLocationScan, onViewLocations }) {
  return (
    <div style={S.mContainer}>
      ...
      <button style={{ ...S.fab, bottom: 144, background: '#84cc16', color: '#0f172a' }} onClick={onViewLocations}>🏭 Almacén</button>
